...
export default function PolicyTable({ rows, loading, onRefresh, onDelete, onEdit, readOnly = false }) {
  const canMutate = !readOnly && Boolean(onEdit || onDelete);
    ...
    <>
      <MagicCard glow="79 70 229" className="overflow-hidden">
        ...
        {loading ? (
          ...
          <MagicEmpty icon={FileText} title="No policies yet" text="Use “Add new policy” to publish the first company policy." />
        ) : (
